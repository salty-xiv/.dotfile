...
sudo cp $HOME/.dotfile/config/nixos/hardware-configuration.nix $HOME/backup/$DATE/
sudo mv $HOME/.dotfile/config/nixos/hardware-configuration.nix $HOME/.dotfile/config/nixos/configuration.nix
