...
hl.on("hyprland.start", function()
  hl.exec_cmd("~/.bashscript/suspend.sh") -- sleep and suspend
  hl.exec_cmd("nm-applet") -- network
  hl.exec_cmd("waybar") -- statusbar
  hl.exec_cmd("wpaperd -d") -- wallpaper
...
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("hyprshot -m output -o $HOME/Pictures/Screenshots/"))
-- # Screenshot a region
hl.bind(mainMod .. " + SHIFT + PRINT", hl.dsp.exec_cmd("hyprshot -m region -o $HOME/Pictures/Screenshots/"))
